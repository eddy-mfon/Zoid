...
export const products: Product[] = [
  { slug: "ac-milan-2526", name: "AC Milan / 25—26", category: "CURATED JERSEY", price: "₦58,500", image: "/manus-storage/ac-milan-2526_b917ea29.jpg", gallery: galleryFor("/manus-storage/ac-milan-2526_b917ea29.jpg"), tone: "Red / Black", style: "Jersey", color: "Red", sizes: ["M", "L", "XL"], stock: { M: 8, L: 3, XL: 6 }, fit: sharedFit, fitNote: sharedFitNote, details: "A classic Rossoneri stripe, selected for the rhythm of the shirt and the weight it carries across generations.", delivery, isBestseller: true },
  { slug: "barcelona-away", name: "Barcelona / Away", category: "ARCHIVE EDITION", price: "₦62,000", image: "/manus-storage/barcelona_9a244f02.jpg", gallery: galleryFor("/manus-storage/barcelona_9a244f02.jpg"), tone: "Onyx / Red", style: "Archive", color: "Black", sizes: ["M", "L", "XL"], stock: { M: 2, L: 7, XL: 4 }, fit: "Relaxed", fitNote: "A roomier archival cut. Size down for a closer silhouette or stay true to size for the full vintage shape.", details: "A dark away expression with a sharp contrast story, curated for late-night streets and long-distance football memory.", delivery, isBestseller: true },
